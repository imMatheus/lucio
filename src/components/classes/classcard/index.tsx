...
import { ClassTypeWithId } from '@/types/ClassTypeWithId'
...
interface ClassesCardProps {
	data: ClassTypeWithId
}

export default function ClassCard({ data: { id, name, code, members, colors, privacy } }: ClassesCardProps) {
	console.log(colors)
