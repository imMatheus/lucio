...
const TestCases: React.FC<TestCasesProps> = ({}) => {
	return (
		<section className="bg-gray-00 w-full border-b border-clr-text bg-clr-bg p-1 dark:border-clr-bg dark:bg-clr-text">
			<h2 className="text-ketchup dark:text-ketchupDark p-5 text-2xl font-semibold">Wrong answer</h2>
			...
			<div className="grid grid-cols-[auto_1fr]">
				...
				<div
					...
					prose-img:max-w-[min(48rem,_100%)] dark:prose-headings:text-clr-bg 
					dark:prose-strong:text-clr-text dark:prose-li:marker:text-clr-bg max-w-none 
					p-5 text-gray-800 
					dark:text-gray-200"
				>
